$(document).ready(function () {
    ...
    function updateTotalPrice() {
        var productsPrices = products.map(function (product) {
            return product.price * product.quantity;
        });
        var total = productsPrices.reduce(function (previous, current) {
    ...
    function renderProducts() {
        products.forEach(function (product) {
            ...
            var actions = '<button type="button" class="btn-decrease btn btn-default">-</button> ' + '<button type="button" class="btn-increase btn btn-default">+</button>';

            var $product = $('<div class="product-row row mt-10"><div class="col-md-4">' + name + '</div><div class="product-value col-md-4">' + price + '</div><div class="col-md-4">' + actions + '</div></div>');
